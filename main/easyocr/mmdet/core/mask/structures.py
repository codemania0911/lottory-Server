...
class BitmapMasks(BaseInstanceMasks):
    ...
    Example:
        >>> from main.easyocr.mmdet.core.mask.structures import *  # NOQA
    ...
    def translate(self,
        ...
        Example:
            >>> from main.easyocr.mmdet.core.mask.structures import BitmapMasks
    ...
    def random(cls,
        ...
        """
        from main.easyocr.mmdet.utils.util_random import ensure_rng
        rng = ensure_rng(rng)
...
class PolygonMasks(BaseInstanceMasks):
    ...
    def random(cls,
        ...
        Example:
            >>> from main.easyocr.mmdet.core.mask.structures import PolygonMasks

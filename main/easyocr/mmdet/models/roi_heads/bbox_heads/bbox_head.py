...
from main.easyocr.mmdet.core import build_bbox_coder, multi_apply, multiclass_nms
from main.easyocr.mmdet.models.builder import HEADS, build_loss
from main.easyocr.mmdet.models.losses import accuracy
from main.easyocr.mmdet.models.utils import build_linear_layer
...
class BBoxHead(BaseModule):
    ...
    def get_bboxes(self,
        ...
        if torch.onnx.is_in_onnx_export():
            from main.easyocr.mmdet.core.export import add_dummy_nms_for_onnx
    ...
    def refine_bboxes(self, rois, labels, bbox_preds, pos_is_gts, img_metas):
        ...
        Example:
            ...
            >>> import kwarray
            >>> import numpy as np
            >>> from main.easyocr.mmdet.core.bbox.demodata import random_boxes
